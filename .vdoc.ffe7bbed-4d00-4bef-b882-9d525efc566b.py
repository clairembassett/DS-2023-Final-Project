...
#
#
 plt.plot(df1[('IMA Accel Total', 'Total Player Load')], label='df1')
plt.plot(df2[('IMA Accel Total', 'Total Player Load')], label='df2')
plt.legend()
plt.title('Total Player Load Comparison')
plt.xlabel('Index')
