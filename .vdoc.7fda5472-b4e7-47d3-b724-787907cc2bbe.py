...
sns.boxplot([df1['IMA Jump Count Med Band'], df2['IMA Jump Count Med Band']])

# Add labels
plt.xticks(['Season 1 IMA Jump Count Med Band', 'Season 2 IMA Jump Count Med Band'])
plt.ylabel('Value')
plt.title('Side-by-Side Box Plot for IMA Jump Count, Med Band, and Explosive Efforts')
