...
# Create the plot
plt.figure(figsize=(8, 6))
plt.scatter(df1['IMA Accel Total'], df1['Total Player Load'])
...
axes[0].set_xlabel('IMA Accel')
axes[0].set_ylabel('Player Load')

sns.scatterplot(data=df2, x='IMA Accel Total', y='Total Player Load', ax=axes[1], color='green')
axes[1].set_title('IA Accel vs Player Load')
axes[1].set_xlabel('IA Accel')
axes[1].set_ylabel('Player Load')
