...
sns.scatterplot(data=df1, x='IMA Jump Count Med Band', y='Total Player Load', ax=axes[0], color='blue')
axes[0].set_title('Season 1 Jump Count High Band vs Player Load')
axes[0].set_xlabel('IMA Decel Total')
axes[0].set_ylabel('Explosive Efforts')

sns.scatterplot(data=df2,x = 'IMA Jump Count Med Band', y='Total Player Load', ax=axes[1], color='green')
